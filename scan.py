...
def update_sites(sites: List[str]) -> Dict:
    ...
    for site in sites:
        ...
        results.update({site: {'has_onion': has_onion, 'version': getattr(version, 'value', None), 'onion_url': escape(onion_url)}})

    # Sort results by version/status (v3 at top, then v2, then no onion or unknown status), then alphabetical order.
    results = dict(sorted(results.items(), key=lambda x: (float('inf') if x[1]['version'] is None else -1 * x[1]['version'], x[0].lower())))
...
def regenerate_site(scan_data: Dict) -> None:
    ...
    NO_ONION = '<li class="list-group-item list-group-item-danger"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M11.854 4.146a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708-.708l7-7a.5.5 0 0 1 .708 0z"/><path fill-rule="evenodd" d="M4.146 4.146a.5.5 0 0 0 0 .708l7 7a.5.5 0 0 0 .708-.708l-7-7a.5.5 0 0 0-.708 0z"/></svg>&nbsp;&nbsp;'
    NO_DATA = '<li class="list-group-item list-group-item-secondary"> <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cloud-slash" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3.112 5.112a3.125 3.125 0 0 0-.17.613C1.266 6.095 0 7.555 0 9.318 0 11.366 1.708 13 3.781 13H11l-1-1H3.781C2.231 12 1 10.785 1 9.318c0-1.365 1.064-2.513 2.46-2.666l.446-.05v-.447c0-.075.006-.152.018-.231l-.812-.812zm2.55-1.45l-.725-.725A5.512 5.512 0 0 1 8 2c2.69 0 4.923 2 5.166 4.579C14.758 6.804 16 8.137 16 9.773a3.2 3.2 0 0 1-1.516 2.711l-.733-.733C14.498 11.378 15 10.626 15 9.773c0-1.216-1.02-2.228-2.313-2.228h-.5v-.5C12.188 4.825 10.328 3 8 3c-.875 0-1.678.26-2.339.661zm7.984 10.692l-12-12 .708-.708 12 12-.707.707z"/></svg>&nbsp;&nbsp;'
    TERMINATOR = "</li>"
